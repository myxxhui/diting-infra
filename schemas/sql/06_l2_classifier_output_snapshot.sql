...
-- 已有库增量：在部署/迁移中按需执行一次
-- ALTER TABLE classifier_output_snapshot ADD COLUMN IF NOT EXISTS segment_shares_json JSONB;
-- ALTER TABLE classifier_output_snapshot ALTER COLUMN primary_tag TYPE VARCHAR(64);
